...
public class prio_out extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_prio_out);

        TextView out_list = findViewById(R.id.prio_list);
    ...
    private class priority implements java.util.Comparator<proccess> {
        @Override
        public int compare(proccess a, proccess b) {
            if(a.at == b.at)return (a.pv - b.pv);
